#ifndef CAFFE_LSTM2_LAYER_HPP_
#define CAFFE_LSTM2_LAYER_HPP_
...
class LSTM2Layer : public Layer<Dtype> {
 public:
  explicit LSTM2Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "LSTM2"; }
